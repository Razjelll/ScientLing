...
import com.dyszlewskiR.edu.scientling.data.models.models.Image;
import com.dyszlewskiR.edu.scientling.utils.BitmapUtils;

import static com.dyszlewskiR.edu.scientling.data.database.tables.ImagesTable.ImagesColumns.BITMAP;
import static com.dyszlewskiR.edu.scientling.data.database.tables.ImagesTable.ImagesColumns.PATH;
import static com.dyszlewskiR.edu.scientling.data.database.tables.ImagesTable.ImagesColumns.WORD_FK;
    ...
    public Image createFromCursor(Cursor cursor) {
        ...
        for (int columnIndex = 0; columnIndex < columnsCount; columnIndex++) {
            switch (cursor.getColumnName(columnIndex)) {
                case WORD_FK:
                    image.setWordId(cursor.getLong(columnIndex));
                    break;
                case BITMAP:
                    image.setBitmap(getBitmapFromCursor(cursor, columnIndex));
                    break;
                case PATH:
